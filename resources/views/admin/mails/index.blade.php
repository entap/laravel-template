...
@section('content')
    ...
    @if (count($mails))
        <table class="table mt-4">
            <thead>
                <tr>
                    <th class="col-8 text-nowrap">@lang('mails.properties.title')</th>
                    <th class="col-2 text-nowrap">@lang('mails.properties.status')</th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>
