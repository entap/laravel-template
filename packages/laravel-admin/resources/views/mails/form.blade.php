<fieldset class="form-group">
    <div class="form-group">
        <label for="title">@lang('admin::mails.properties.title')</label>
        <div>
    ...
    <div class="form-group">
        <label for="description">@lang('admin::mails.properties.description')</label>
        <div>
...
<fieldset class="form-group">
    <div class="form-group">
        <label for="mail_type_id">@lang('admin::mails.properties.mail_type')</label>
        <div>
    ...
    <div class="form-group">
        <label for="from">@lang('admin::mails.properties.from')</label>
        <div>
    ...
    <div class="form-group">
        <label for="to">@lang('admin::mails.properties.to')</label>
        <div>
    ...
    <div class="form-group">
        <label for="subject">@lang('admin::mails.properties.subject')</label>
        <div>
    ...
    <div class="form-group">
        <label for="body">@lang('admin::mails.properties.body')</label>
        <div>
...
<fieldset class="form-group">
    <div class="form-group">
        <label for="status">@lang('admin::mails.properties.status')</label>
        <div>
    ...
    <div class="form-group">
        <label for="starts_at">@lang('admin::mails.properties.start_date')</label>
        <div>
    ...
    <div class="form-group">
        <label for="expires_at">@lang('admin::mails.properties.expire_date')</label>
        <div>
